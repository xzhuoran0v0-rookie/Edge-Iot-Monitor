...
| `SENSE_INTERVAL_MS` | Floor of the adaptive reasoning/OLED/local-backend cycle, default 2000. The interval stretches toward 10 s in a calm room and snaps back here on any event. Not metered |
